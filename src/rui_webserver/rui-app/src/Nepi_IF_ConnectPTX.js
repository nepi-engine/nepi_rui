...
import NepiIFPTXData from "./Nepi_IF_PTX-Data"
import NepiIFPTXControls from "./Nepi_IF_PTX-Controls"

@inject("ros")
@observer

// Reusable component that renders the device selector for a PTX pan/tilt device
// connected through the ConnectPTXDeviceIF interface, and composes the data and
...
// flags) only -- the two children each own their own DevicePTXStatus
