...
class NepiAdmin extends Component {
  ...
  renderAdminControls(){
    ...
    const show_admin_config = (this.props.show_admin_config !== undefined)? this.props.show_admin_config : true
    const show_admin_node_name = (this.props.show_admin_node_name !== undefined)? this.props.show_admin_node_name : true
    const show_admin_modes = (this.props.show_admin_modes !== undefined)? this.props.show_admin_modes : true
    const namespace = (this.props.namespace !== undefined) ? this.props.namespace : 'None'



    if (admin_mode_set === false){
      return (
  ...
  render() {
    ...
    if (base_namespace == null){
      ...
      return (
          ...
          <Section title={("NEPI System Configuration")}>
