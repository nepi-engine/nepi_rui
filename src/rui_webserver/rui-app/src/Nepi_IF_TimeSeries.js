...
class NepiIFTimeSeries extends Component {
  constructor(props) {
    super(props)
    ...
    this.renderTimeSeriesIF = this.renderTimeSeriesIF.bind(this)
  ...
  getNamespace(){
    const namespace = (this.props.namespace !== undefined) ? this.props.namespace  + '/' + this.state.topic : null
    return namespace
  }
  ...
  updateStatusListeners() {
    ...
    if (namespace != null){
      ...
      var statusListener = this.props.ros.setupStatusListener(
        namespace + '/status',
        "nepi_interfaces/TimeSeriesStatus",
        this.statusListener
      )
      this.setState({ 
  ...
  render() {
    ...
    if (namespace == null && status_msg == null){
      ...
      return (
          ...
          <Section title={(this.props.title !== undefined) ? this.props.title : "TimeSeries"}>
...
export default NepiIFTimeSeries
