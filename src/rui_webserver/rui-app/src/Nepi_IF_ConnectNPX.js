...
import NepiIFNPXData from "./Nepi_IF_NPX-Data"
import NepiIFNPXControls from "./Nepi_IF_NPX-Controls"

@inject("ros")
@observer

// Reusable component that renders the device selector for an NPX navpose device
// connected through the ConnectNPXDeviceIF interface, and composes the data and
...
// flags) only -- the two children each own their own DeviceNPXStatus
